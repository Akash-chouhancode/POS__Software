                    ...
                    <form onSubmit={handleSubmit}>
                       ...
                       <div>
                        <div className="mb-11 flex gap-x-6">
                          <label className="m-auto text-left text-gray-700 font-semibold mb-2">
                            Food Name*
                          </label>
                          <select
                            name="itemid"
                            ...
                            className="shadow border border-[#4CBBA1] md:min-w-[300px] rounded py-2 px-3 text-gray-700"
                          >
                      ...
                      <div className="mb-11 flex gap-x-5">
                        <label className="m-auto w-[100px] text-left text-gray-700 font-semibold mb-2">
                          Variant Name*
                        </label>
                        <select
                          name="itemvid"
