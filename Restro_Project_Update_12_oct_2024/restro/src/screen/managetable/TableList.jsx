...
const { isFullScreen, toggleFullScreen } = useFullScreen();
 ...
 const totalPages = Math.ceil(floors.length / itemsPerPage);
  ...
  const submitTableData = (e) => {
    ...
    // if (tableFile) {
    //   formData.append("table_icon", tableFile || null);
    // }
  ...
  const handleSubmit2 = (e) => {
    ...
    axios
      ...
      .then(() => {
        toast.success("Table updated sucessfullu!");
        GetTableData();
  ...
  const handleSubmit3 = (e) => {
    ...
    axios
      ...
      .then(() => {
        toast.success("Floor updated sucessfullu!");
        GetFloorData();
                    ...
                    <table className="min-w-full bg-white text-center">
                      ...
                      {tables.length > 0 ? (
                        ...
                        ((row, index) => (
                          ...
                          <HasPermission module="Table & Floor Manage" action="edit">
                          <Tooltip message="Edit">
                                  <button
                                    onClick={() => handleEditClick(row.tableid)}
                                ...
                                <HasPermission  module="Table & Floor Manage" action="delete">
            ...
            {tables.length > 0 && (
              <div className="mt-10">
                <div className="float-right flex items-center space-x-2">
                  ...
                  {[...Array(Math.ceil(tables.length / itemsPerPage))].map(
                    (_, index) => {
                      return (
                        <button
                  ...
                  <button
                    onClick={() => selectPage(currentPage + 1)}
                    disabled={
                      currentPage === Math.ceil(tables.length / itemsPerPage)
                    }
                    className="h-[46px] w-[70px] cursor-pointer border-[1px] border-[#1C1D3E] disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Next
            ...
            <div className=" contant_div w-full  ml-4 pr-7 mt-4 ">
              <div className="mt-12">
                <form
                  ...
                  className="flex justify-end gap-x-11 mb-4"
                >
                  <div className="gap-x-3 flex items-center">
                    ...
                    <input
                      ...
                      className="shadow w-[222px] border-[#4CBBA1] appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                      id="floorName"
                      type="text"
                      value={floorData.floorName} // Use the value from floorData
                      onChange={handleInputChange}
                    />
                  </div>
                  <button
                    type="submit"
                    className="bg-[#1C1D3E] h-[40px] w-[100px] rounded text-white font-semibold"
                  >
                    Add
                  </button>
                </form>
