...
const AddOneAssignList = () => {
  ...
  const headers = ["SL.", "Add On Name", " Food Name ", "Action"];
        ...
        <section className=" side_section flex">
          ...
          <div className=" contant_div w-full  ml-4 pr-7 mt-4 ">
            ...
            <div className=" flex justify-between mt-11">
              ...
              <button
                className=" bg-[#4CBBA1] h-[46px] text-nowrap w-[200px] rounded-sm  flex justify-center items-center
...
export default AddOneAssignList;
