  ...
  const checkAvailability = async (e) => {
    ...
    const submitAddcustomer = (e) => {
      ...
      if (!formData.customer_name) {
        toast.error("Please fillcustomer name");
        return;
      }
  ...
  <div className="p-5 h-[700px] overflow-y-scroll">
    ...
    {Array.isArray(freeTable) && freeTable.length === 0 ? (
      <div className="flex items-center justify-center w-full h-full">
        <h1 className="text-gray-500 text-lg">Please fill detais to see available tables..</h1>
      </div>
    ): (
                ...
                <div>
                  <div className="w-[200px]">
                    ...
                    <div className="flex">
                      ...
                      <h1 className="text-nowrap">{val.person_capicity}</h1>
                    </div>
                  </div>
                </div>
              </div>
