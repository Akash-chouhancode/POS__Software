...
const Log_in = () => {
  ...
  return (
    ...
    <div
      className="relative flex flex-col lg:flex-row items-center justify-center h-auto w-full max-w-4xl bg-gray-500 bg-no-repeat bg-cover p-6 lg:p-12 rounded-md"
    ...
    >
      ...
      {/* Text Content */}
      <div className="relative z-10 text-center lg:text-left text-white lg:max-w-sm pr-10 hidden lg:block">
        <h1 className="text-4xl font-bold tracking-wide">Keep it special</h1>
        <p className="text-2xl my-4">Nothing brings people together like good food.</p>
      </div>

      {/* Form */}
      <div className="relative lg:h-[500px] lg:w-[450px] xl:w-[500px] w-full h-auto z-10 bg-white p-8 rounded-md shadow-lg flex flex-col items-center gap-y-8 max-w-md">
        ...
        <Link to="/forgetpassword" className="text-[#1b1638] tracking-widest font-serif">
          Forgot password?
        </Link>
