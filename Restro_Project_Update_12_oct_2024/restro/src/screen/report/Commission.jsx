...
const totalAmount= waiterData.reduce((acc,row)=> acc + parseFloat(row.totalamount || 0),0);
...
const downloadExcel = async () => {
  ...
  worksheet.columns = [
    { header: "Waiter Name", key: "waiter_name" },
    { header: "Total Amount", key: "total_amount" },
    { header: "Commission Rate", key: "commission_rate" },
                        ...
                        waiterData
                          ...
                          .map((row, index) => (
                            <tr key={index} className="border-b text-center ">
                              ...
                              <td className="py-2 px-4 border border-[#4CBBA1]">
                                {row.WaiterName? row.WaiterName:"No Name found"}
                              </td>

                              <td className="py-2 px-4 border border-[#4CBBA1]">
                                {(row.totalamount).toFixed(2) ? (row.totalamount).toFixed(2) :"Not defined" }
                              </td>
                              <td className="py-2 px-4 border border-[#4CBBA1]">
                                {((row.totalamount*row.commissionRate)/100)}
                              </td>
