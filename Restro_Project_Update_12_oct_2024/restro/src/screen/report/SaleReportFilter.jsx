...
const SaleReportFilter = () => {
  ...
  const getServiceSaledata = () => {
    axios
      .get(`${API_BASE_URL}/salereportfilter`)
      .then((response) => {
  ...
  const handleSearch = async (e) => {
    ...
    try {
      const response = await axios.get(`${API_BASE_URL}/salereportfilter`, {
        params: {
          from: fromDate,
          to: toDate,
        },
  ...
  const downloadCSV = async () => {
    ...
    const csvData = data.map((item) => ({
      Invoice_Number: item.saleinvoice,
                        ...
                        serviceData
                          ...
                          .map((row, index) => (
                            <tr key={index} className="border-b text-center ">
                              ...
                              <td className="py-2 px-4 border border-[#4CBBA1]">
                                {row.saleinvoice ? row.saleinvoice : "No Id"}
                              </td>
                              <td className="py-2 px-4 border border-[#4CBBA1]">
                                {row.customer_name
                                  ? row.customer_name
                              ...
                              <td className="py-2 px-4 border border-[#4CBBA1]">
                                {row.customertype ? row.customertype : "No Id"}
                              </td>
                              <td className="py-2 px-4 border border-[#4CBBA1]">
