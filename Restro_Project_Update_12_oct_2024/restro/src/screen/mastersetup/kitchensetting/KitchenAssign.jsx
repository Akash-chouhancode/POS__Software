                ...
                <div>
                  <div className="mb-11 flex ">
                    ...
                    <select
                      name=""
                      id=""
                      className="shadow border border-[#4CBBA1]  md:min-w-[500px] rounded  py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outlin"
                    >
                ...
                <div className=" flex gap-x-11 ">
                  <div className="mb-11 flex gap-x-5">
                    ...
                    <select
                      ...
                      className="shadow border border-[#4CBBA1]   md:min-w-[500px] rounded  py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outlin"
                    >
                      <option value="">Kitchen Name</option>
                      <option value="">Kitchen Name</option>
                    </select>
                  </div>
                  <div>
                    <button className="bg-[#4CBBA1] w-[104px] h-[40px] rounded-sm  text-nowrap text-white  text-base">
                      Save
                    </button>
                  </div>
                </div>
