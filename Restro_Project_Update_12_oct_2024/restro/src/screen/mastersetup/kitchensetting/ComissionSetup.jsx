...
const ComissionSetup = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`${API_BASE_URL}/postcommission`, formdata,{headers:{"Authorization":token}})
      .then((response) => {
...
e.preventDefault();
axios.put(`${API_BASE_URL}/updatecomission/${editId}`, formData2)
.then(() => {
                        ...
                        .map((row, index) => (
                          <tr key={index}>
                            ...
                            <td className="py-2 px-4 border border-[#4CBBA1]">
                              ...
                              <HasPermission module="Commission Setup" action="edit">
                                ...
                                <HasPermission module="Commission Setup" action="delete">
          ...
          <div className="  w-auto px-20 ">
            <div className=" py-4  bg-white  rounded-md shadow-md border-[1px] border-[#1C1D3E]">
              <div className="flex  py-5 px-4 justify-between items-center border-b-[1px] border-black">
                <h2 className="text-xl  font-semibold">Edit Commission Setting</h2>
                <button
